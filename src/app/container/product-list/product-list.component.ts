...
@Component({
  selector: 'container-product-list',
...
export class ProductListComponent {
  ...
  inStockProducts: number = this.products.filter(p => p.is_in_inventory == true).length;
  outOfStockProducts: number = this.products.filter(p => p.is_in_inventory == false).length;
  selectedRadio: string = 'all';
  filterChanged(radio: string) {
